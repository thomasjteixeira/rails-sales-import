...
```bash
git clone https://github.com/thomasjteixeira/rails-sales-import.git
...
Este projeto é baseado no desafio técnico disponível em: [nuuvem-public/tests/web-1](https://gitlab.com/nuuvem-public/tests/web-1)
